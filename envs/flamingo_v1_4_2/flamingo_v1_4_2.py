...
import numpy as np
import mujoco
from envs.flamingo_v1_4_2.manager.control_manager import ControlManager
from envs.flamingo_v1_4_2.manager.xml_manager import XMLManager
from envs.flamingo_v1_4_2.utils.math_utils import MathUtils
from envs.flamingo_v1_4_2.utils.mujoco_utils import MuJoCoUtils
from envs.flamingo_v1_4_2.utils.noise_generator_utils import truncated_gaussian_noisy_data, uniform_noisy_data
import glfw


class FlamingoV1_4_2(MujocoEnv, utils.EzPickle):
    metadata = {"render_modes": ["human", "rgb_array", "depth_array"]}
    def __init__(self, config, render_flag=True, render_mode='human'):
        # Set Basic Properties
        self.id = "flamingo_v1_4_2"
        self.config = config
