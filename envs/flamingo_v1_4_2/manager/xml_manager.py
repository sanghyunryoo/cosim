...
class XMLManager:
    ...
    def get_model_path(self):
        original_model_path = os.path.join(self.cur_dir, '..', 'assets', 'xml', 'flamingo_v1_4_2.xml')
        ...
        randomized_model_path = os.path.join(self.cur_dir, '..', 'assets', 'xml', 'applied_flamingo_v1_4_2.xml')
