...
from envs.flamingo_p_v3.utils.noise_generator_utils import truncated_gaussian_noisy_data, uniform_noisy_data
...
class FlamingoPV3(MujocoEnv, utils.EzPickle):
    ...
    def __init__(self, config, render_flag=True, render_mode='human'):
        ...
        qpos_joint_names = ["left_hip_joint", "right_hip_joint", "left_shoulder_joint", "right_shoulder_joint",
                             "left_leg_joint", "right_leg_joint"]
        qvel_joint_names = ["left_hip_joint", "right_hip_joint", "left_shoulder_joint", "right_shoulder_joint",
                             "left_leg_joint", "right_leg_joint", "left_wheel_joint", "right_wheel_joint"]
    ...
    def _get_obs(self):
        ...
        dof_pos[4:6] = dof_pos[4:6] * self.gear_ratio 

        dof_vel = self.data.qvel[self.qd_indices].copy()
        dof_vel[4:6] = dof_vel[4:6] * self.gear_ratio 
    ...
    def step(self, action):
        ...
        pos_leg = dof_pos[4:6] * self.gear_ratio

        # Motor vel
        vel_hip = dof_vel[0:2]
        vel_shoulder = dof_vel[2:4]
        vel_leg = dof_vel[4:6] * self.gear_ratio
        ...
        leg_torques = leg_torques * np.array([self.gamma, self.gamma], dtype=np.float64)
    ...
    def _get_info(self):
        ...
        joint_state = [dof_pos[0], dof_pos[1], dof_pos[2], dof_pos[3], dof_pos[4], dof_pos[5], dof_vel[6], dof_vel[7]]
    ...
    def _is_done(self):
        ...
        contact = base_contact.any() or hip_l_contact.any() or hip_r_contact.any() or shoulder_l_contact.any() or shoulder_r_contact.any()
        return contact
