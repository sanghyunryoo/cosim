...
import mujoco
import glfw
from envs.flamingo_light_v1.manager.control_manager import ControlManager
from envs.flamingo_light_v1.manager.xml_manager import XMLManager
from envs.flamingo_light_v1.utils.math_utils import MathUtils
from envs.flamingo_light_v1.utils.mujoco_utils import MuJoCoUtils
from envs.flamingo_light_v1.utils.noise_generator_utils import truncated_gaussian_noisy_data, uniform_noisy_data


class FlamingoLightV1(MujocoEnv, utils.EzPickle):
    metadata = {"render_modes": ["human", "rgb_array", "depth_array"]}
    def __init__(self, config, render_flag=True, render_mode='human'):
        # Set Basic Properties
        self.id = "flamingo_light_v1"
        self.config = config
        self.action_dim = 4
    ...
    def initial_qpos(self):
        ...
        qpos[2] = 0.13  # Initial height: 0.115
